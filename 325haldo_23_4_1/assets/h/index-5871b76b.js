...
left:\`+( (LarghezzaPianoterra *0.5) - (LarghezzaPianoterra * 0.75 * 0.50) )+\`rem;
	...
	// 		alert("App325hv12_ 20:23:03:25:18:33 debug TESTAPP ok!");
	}; // TESTAPP
	...
	// 	alert("2023:03:16:09:35 svelte compiled ok!");`,N=u(),p=m("style"),p.textContent=`main{
