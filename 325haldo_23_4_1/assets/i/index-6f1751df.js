...
// Possibile applicare una correzione   
   let LarghezzaPianoTerra = (LarghezzaApplicazione_Rem * (1) );
   let AltezzaPianoTerra   = (AltezzaApplicazione_Rem   * (1) );
   let LarghezzaPrimoPiano = (LarghezzaApplicazione_Rem * (1) );
   let AltezzaPrimoPiano   = (AltezzaApplicazione_Rem   * (1) );
...
left:\`+( (LarghezzaPianoterra *0.5) - (LarghezzaPianoterra * 0.75 * 0.50) )+\`rem;
	...
	// 		alert("App325iv12_ 20:23:03:25:19:00 debug TESTAPP ok!");
	}; // TESTAPP
