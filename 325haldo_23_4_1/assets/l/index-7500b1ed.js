...
// ////////////////////////////////////////////////////////////////////////
// ////////////////////////////////////////////////////////////////////////
// Possibile applicare una correzione   
   let LarghezzaPianoTerra = (LarghezzaApplicazione_Rem * (1/2.00) );
   let AltezzaPianoTerra   = (AltezzaApplicazione_Rem   * (1/1.25) );
   let LarghezzaPrimoPiano = (LarghezzaApplicazione_Rem * (1/2.00) );
   let AltezzaPrimoPiano   = (AltezzaApplicazione_Rem   * (1/1.25) );
...
left:\`+( (LarghezzaPianoterra *0.5) - (LarghezzaPianoterra * 0.75 * 0.50) )+\`rem;
	...
	// 		alert("App325lv12_ 20:23:03:25:19:15 debug TESTAPP ok!");
	}; // TESTAPP
	...
	// 	alert("2023:03:16:09:35 svelte compiled ok!");`,h=u(),p=m("style"),p.textContent=`main{
