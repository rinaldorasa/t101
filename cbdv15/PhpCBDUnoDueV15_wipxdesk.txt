...
CBD_23729_0845a_vid3820725_V15__08_56_wip
...
/*    FonteSizeStandard__=2.75*1.000;  */     /* mobile first */
/*    FonteSizeStandard__=2.75*1.500;  */     /* mobile first */ /* testing code */
/*    FonteSizeStandard__=2.75*1.750;  */     /* mobile first */ /* testing code */
      FonteSizeStandard__=2.75*2.000;       /* mobile first */ /* testing code */
	
	
/*  FonteSizeStandard__=2.75*0.50; */ /* mobile first */ /* testing for desktop */


FonteSizeStandard__=2.75*0.50; 
...
<style>
    ...
    border:solid 1.75rem orange; border:solid 1.75rem #BBE3C3; border-top:solid 1.75rem transparent;border-radius:50%; display:inline-block;
    animation: spin 1.5s linear infinite;
    }
...
<!-- TENTATIVO DI RESPONSIVITY helped by bardo google 

<div id="EXPORT_VALORE_STANDARD__"></div>
<button id="ButtonExportValoreStandard__" style="background-color:var(--blue-v15); color:var(--green-v15);  font-size:`+(FonteSizeStandard__*0.250)+`rem;">DESKTOP</button>
...
-->
 ...
 <i  id="EDITOR_AFILE__" onclick="EditoreAppend()" class="bi bi-terminal-fill"  style=" position:fixed; top:`+(FonteSizeStandard__*0.00)+`rem; right:`+(FonteSizeStandard__*0.00)+`rem;background-color:inherit;background-color:orange; background-color:#FFFFFF; color:#BBE3C3; "></i>
...
-->
	...
	<i  id="EVIDENZIA_OPZIONI__" onclick="EvidenziaOpzioni()" class="bi bi-gear"  style=" position:fixed; top:`+( FonteSizeStandard__*1.50 )+`rem; right:`+(FonteSizeStandard__*0.00)+`rem;background-color:inherit;background-color:orange;background-color:#BBE3C3; color:white;"></i>
...
<li><span style="background-color:white; color:black; font-size:`+(FonteSizeStandard__*0.25)+`rem;">CBD_23729_0845a_vid3820725_V15__08_56_wip</span></li>
...
<li><button  onclik="CambiaFonteSizeStandard()">FonteSizeStandard__= 1</button></li>
<li></li>
<li></li>
<li></li>
<li></li>
...
<article id="Inserisce_il_nome_del_file_da_cercare__">
    <input type="text" placeholder="Testo.txt" id="INPUT_NOME_FILE__" value="Testo.txt" class="centrato___ fs_standard___ no_bordi___"  style="background-color:white;color:black;font-family:monospace; border:solid 0.075rem #BBE3C3; border-radius:0.50rem;">
</article>
...
CONTROLLARE I SEGUENTI BOTTONI
RIGUARDO ALLE DIMENSIONI DELLE ICONE SVG


-->


<article style="position:fixed; top:`+(FonteSizeStandard__*1.525)+`rem;left:0rem;border:solid 0.00rem red;">
<aside  id="StopAndGoSi__" onclick="CopySi()" >
<i style="font-size:`+(FonteSizeStandard__*1.25)+`rem;" class="bi bi-pause-btn-fill"></i>
</aside>
</article>

<article style="position:fixed; top:`+(FonteSizeStandard__*1.525)+`rem;left:0rem;border:solid 0.00rem red;">
<aside  id="StopAndGoNo__" onclick="CopyNo()"  style="display:none;">
<i style="font-size:`+(FonteSizeStandard__*1.25)+`rem;" class="bi bi-play-btn-fill"></i>
</aside>
</article>
...
<section id="VisualizzaCommento_01_Box__" class="da_mo__">    
    ...
    <div id="RicercaFile__" style="color:var(--red-v15); font-size:`+(FonteSizeStandard__*0.25)+`rem;">RICERCA...</div>
    </blockquote>
...
<div id="FullPaginaSi__" onclick="FullPaginaSi()"  style="background-color:#BBE3C3;color:#FFFFFF;font-size:`+FonteAppUpdated__+`rem;">&#61;CBD_23729_0845a_vid3820725_V15__08_56_wip&#61;
	</div>
<div id="FullPaginaNo__" onclick="FullPaginaNo()"  style="background-color:#BBE3C3;color:#BBE3C3;font-size:`+FonteAppUpdated__+`rem;opacity:0.25;">&#61;CBD_23729_0845a_vid3820725_V15__08_56_wip&#61;
	</div>
...
border-bottom:solid 0.15rem #BBE3C3!important;
...
border-top:solid 0.015rem #BBE3C3;
...
#StopAndGoSi__{color:red;   color:var(--red-v15);  }
#StopAndGoNo__{color:green; color:var(--green-v15);}
...
${AppUpdated__}`;
  ...
  document.getElementById("ButtonExportValoreStandard__").onclick = function() {
  document.getElementById("EXPORT_VALORE_STANDARD__").innerHTML = `<style>html * {font-size:`+(FonteSizeStandard__*0.5)+`rem;}</style>
  `;
