...
CBD_23727_1230aa_vid3820725_V14__12_41_wip
...
-->
	...
	<i  id="EVIDENZIA_OPZIONI__" onclick="EvidenziaOpzioni()" class="bi bi-gear"  style=" position:fixed; top:`+(FonteSizeStandard__*1.00)+`rem; right:`+(FonteSizeStandard__*0.00)+`rem;background-color:inherit;background-color:orange;"></i>
...
<li><span style="background-color:white; color:black; font-size:`+(FonteSizeStandard__*0.25)+`rem;">CBD_23727_1230aa_vid3820725_V14__12_41_wip</span></li>
...
<i  id="NAVIGAZIONE_INTERNA_ALLA_PAGINA_INI__" onclick="NavigazioneInternaAllaPaginaIni()" class="bi bi-chevron-double-up"  style=" position:fixed; top:`+(FonteSizeStandard__*3.00)+`rem; right:`+(FonteSizeStandard__*0.00)+`rem;background-color:inherit;background-color:orange;"></i>
<i  id="NAVIGAZIONE_INTERNA_ALLA_PAGINA_FIN__" onclick="NavigazioneInternaAllaPaginaFin()" class="bi bi-chevron-double-down"  style=" position:fixed; top:`+(FonteSizeStandard__*4.00)+`rem; right:`+(FonteSizeStandard__*0.00)+`rem;background-color:inherit;background-color:orange;"></i>
...
InizioDellaPagina__
 ...
 FullPaginaNo__
	...
	#fine__{color:blue;font-size:`+FonteAppUpdated__+`rem;border:solid 0.00rem purple;}</style>

<div id="FullPaginaSi__" onclick="FullPaginaSi()"  style="background-color:inherit;color:green;font-size:`+FonteAppUpdated__+`rem;">&#61;CBD_23727_1230aa_vid3820725_V14__12_41_wip&#61;
	</div>
<div id="FullPaginaNo__" onclick="FullPaginaNo()"  style="background-color:teal;color:teal;font-size:`+FonteAppUpdated__+`rem;opacity:0.25;">&#61;CBD_23725_1000b_vid3820725_V14__10_06_wip&#61;
	</div>
