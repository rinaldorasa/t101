...
#NASCONDI_NAVIGAZIONE_INTERNA__{position:absolute;top:`+(FontSizeStandard__*0.00)+`rem;left:75%;background-color:`+CreaColoreRandom__+`!important;border:solid 0.25rem red;border-radius:0.50rem; display:inline-block;}

#VEDI_NAVIGAZIONE_INTERNA__{position:absolute;top:`+(FontSizeStandard__*0.75)+`rem;left:75%;background-color:`+CreaColoreRandom__+`!important;border:solid 0.25rem green;border-radius:0.50rem;  display:inline-block;}
