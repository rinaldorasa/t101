...
TheRollingThunderProject released THE_APPHP_UNO_DUE_23610_1000a_PhpAllUnoDueV01
...
<span id="CHIUDI_QUESTION_MARK_POPUP_TITOLO__">TheRollingThunderProject released THE_APPHP_UNO_DUE_23610_1000a_PhpAllUnoDueV01</span>
</blockquote>
</aside>
...
#FILE_RICHIESTO__{margin-right: `+(FontSizeStandard__*1)+`rem;  background-color:`+CreaColoreRandom__+`!important;border-radius:0.25rem;}
...
#NASCONDI_NAVIGAZIONE_INTERNA__{position:absolute;top:`+(FontSizeStandard__*0.25)+`rem;left:75%;background-color:`+CreaColoreRandom__+`!important;font-size:`+(FontSizeStandard__*0.00)+`rem;border:solid 1.500rem red;border-radius:0.250rem; display:inline-block;}

#VEDI_NAVIGAZIONE_INTERNA__{position:absolute;top:`+(FontSizeStandard__*1.00)+`rem;left:75%;background-color:`+CreaColoreRandom__+`!important;font-size:`+(FontSizeStandard__*0.00)+`rem;border:solid 1.500rem green;border-radius:0.250rem;  display:inline-block;}
...
let DirectoryDove_File_02__="./txt/";
DirectoryDove_File_02__="";
  let File_02__="Commento.txt"; File_02__ = DirectoryDove_File_02__+File_02__ + "?"+(new Date().getTime()) + (Math.random()) ; 
  let Richiedo_02__ = new XMLHttpRequest();
    
  Richiedo_02__.open("GET",File_02__,false);
  Richiedo_02__.onreadystatechange = function(){let Trovato_02__ = Richiedo_02__.responseText;
          
      Commento_02__ =    Trovato_02__;
...
DirectoryDove="";
  let File_02="Commento.txt"; File_02 = DirectoryDove+File_02 + "?"+(new Date().getTime()) + (Math.random()) ; 
  let Richiedo_02 = new XMLHttpRequest();
    
  Richiedo_02.open("GET",File_02,false);
  Richiedo_02.onreadystatechange = function(){let Trovato_02 = Richiedo_02.responseText;
