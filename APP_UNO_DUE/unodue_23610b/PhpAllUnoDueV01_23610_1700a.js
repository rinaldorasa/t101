...
#NASCONDI_NAVIGAZIONE_INTERNA__{position:absolute;top:`+(FontSizeStandard__*0.25)+`rem;left:75%;background-color:`+CreaColoreRandom__+`!important;font-size:`+(FontSizeStandard__*0.250)+`rem;border:solid 0.25rem red;border-radius:0.50rem; display:inline-block;}

#VEDI_NAVIGAZIONE_INTERNA__{position:absolute;top:`+(FontSizeStandard__*1.00)+`rem;left:75%;background-color:`+CreaColoreRandom__+`!important;font-size:`+(FontSizeStandard__*0.250)+`rem;border:solid 0.25rem green;border-radius:0.50rem;  display:inline-block;}
