...
Archivio_CercaALFA=[""];
Archivio_CercaALFA[0]="htm_wippy.txt";

CercaALFA=Archivio_CercaALFA[0];

CSRFXVXX="csrfxvxx.php";
...
if ($_POST['csrfToken'] !== $_COOKIE['csrfToken']) {
  ...
  echo "</div>";  
  echo '<script> function csrf(){window.location.replace("'.$Archivio_csrfxvxx.'");} setTimeout(csrf, 5000)</script>';   
...
CercaALFA=CercaALFA+"?"+Math.random(); 
