...
echo '<form id="w_a_1_1_FORM_X_INVIA_AES__" action="funicoty13.php" method="POST">';
...
echo '<a href="https://www.rinaldo-rasa.it/funicoty13/index.html" class="ui red inverted button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" class="bi bi-arrow-clockwise" viewBox="0 0 16 16">
...
release FUNICOTY13_240322_1900a   : verde, nook, sparrow, sixties
 &copy; 2024
</q>
...
echo '<a href="https://www.rinaldo-rasa.it/funicoty13/index.html" class="ui  inverted button">
